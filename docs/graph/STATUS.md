...
**Project:** Todo App · **Updated:** 2026-07-10 · **Phase:** FND in progress — FND-001 ✅ merged (PR #3); FND-002 runnable
...
|---|---|---|---|---|---|
| 1 | **FND** — Foundation & App Shell (⚓) | 9 | 5 (1 done) | — | 🟡 in progress (FND-001 ✅ done) |
...
| **FND-002** | Design system + theming (light + dark) ⚓ | F-045 | M | 4h | FND-001 ✅ | — | 🔵 ready (runnable) |
...
**Next runnable:** 🔵 **FND-002** (Design system + theming — UI/design anchor). **FND remaining:** 14h (4 tasks).
...
**Next:** `/build FND-002` (Design system + theming).
