...
**Project:** Todo App · **Updated:** 2026-07-10 · **Phase:** FND in progress — FND-001 ✅ merged (PR #3); FND-002 ✅ merged (PR #4); FND-003 ✅ merged (PR #5); FND-004 gates green (1-iteration loop), PR #6 open, awaiting human merge-go
...
|---|---|---|---|---|---|
| 1 | **FND** — Foundation & App Shell (⚓) | 9 | 5 (3 done, 1 review, 1 ready) | — | 🟡 in progress (FND-001/002/003 ✅ done; FND-004 in review; FND-005 ready) |
...
| **FND-004** | Bootstrap: splash · first-launch · offline | F-043/044/048 | M | 4h | FND-001/002/003 ✅ | — | 🟡 review — PR #6, gates green (1-iteration loop), awaiting human merge-go |
...
**Next runnable:** 🔵 **FND-005** — the only remaining FND task. Once it's done, the **FND Module DoD** fires: coherence review (architect + security-reviewer) + local E2E gate, then human integration go.
...
**Next:** human merge-go on PR #6 (FND-004), then `/build FND-005` (already runnable independently). After FND-005 merges → `/coherence FND`.
