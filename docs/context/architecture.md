...
- `Tabs` — the bottom-tab navigator (`TabParamList`: `Home`, `Profile`). **Profile** is now the real `ProfileScreen` (PRO-002, PR #11 merged) — **Home** still a placeholder, built out in **TSK**.
