...
>
> Empty until you run `/intake` (ingest the PRD + feature list) then `/scope`.

| Feature | Title | Module | Task | Spec (brief) | Status |
|---|---|---|---|---|---|
| _(none yet — run `/intake`)_ | | | | | |

**Coverage:** 0 features · 0 mapped · 0 orphans
