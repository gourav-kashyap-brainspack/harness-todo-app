...
| F-009 | View Task Details | P0 | Tasks | TSK | TSK-003 | Task detail + edit | review |
| F-010 | Edit Task | P0 | Tasks | TSK | TSK-003 | Task detail + edit | review |
...
| F-018 | Display Task Creation Date | P2 | Tasks | TSK | TSK-003 | Task detail + edit | review |
| F-019 | Display Last Updated Date | P2 | Tasks | TSK | TSK-003 | Task detail + edit | review |
...
| F-040 | Navigate to Task Details | P0 | Navigation | TSK | TSK-003 | Task detail + edit | review |
| F-041 | Navigate to Edit Task | P0 | Navigation | TSK | TSK-003 | Task detail + edit | review |
